...
const projects = [
  ...
  },
  {
    ...
    problem: "Creating professional slide decks is time-consuming and inconsistent. Teams need fast, high-quality presentations with live data integration and seamless export capabilities.",
    approach: "Building a comprehensive AI-powered slide generation platform with 5 beautiful themes, live widgets (charts, tickers, countdowns, maps), inline editing, and export to PDF/PPTX with perfect formatting.",
    impact: "Will enable rapid creation of professional slide decks with one-prompt generation, real-time data widgets, 5 stunning themes, and faithful PDF/PPTX exports. Supports both OpenAI and local Ollama models.",
    image: "/api/placeholder/400/250",
