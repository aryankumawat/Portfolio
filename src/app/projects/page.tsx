...
const projects = [
  {
    ...
    description: "Comprehensive bioinformatics pipeline analyzing 122 scalp skin biopsies from GSE68801 dataset. Features differential expression analysis, LASSO feature selection identifying 21 key genes, and multiple ML models (Random Forest, SVM, GLMNET, kNN) with 92% AUC performance. Deployed interactive Shiny web application for real-time risk assessment with individual/batch prediction capabilities.",
    category: "Machine Learning",
    icon: Code,
    color: "from-blue-500 to-blue-600",
    year: "2025",
    status: "Completed",
    technologies: ["R", "Shiny", "Machine Learning", "Bioinformatics", "LASSO", "Random Forest", "SVM", "Gene Expression Analysis"],
    problem: "Alopecia Areata affects 2% of the population worldwide, but current diagnostic methods are limited and subjective. There's a critical need for early detection and personalized risk assessment tools using molecular biomarkers from gene expression data.",
    approach: "Developed comprehensive bioinformatics pipeline: (1) GCRMA normalization and quality control of microarray data, (2) Differential expression analysis using limma with FDR correction, (3) LASSO feature selection identifying 21 predictive genes, (4) Multiple ML model training with 10-fold cross-validation, (5) Interactive Shiny app deployment with individual/batch prediction capabilities",
    impact: "Achieved 92% AUC with 85% accuracy using Random Forest model, successfully identifying 21 key genes associated with AA risk. The deployed Shiny app enables clinicians and researchers to perform real-time risk assessments, potentially improving early diagnosis and treatment outcomes for thousands of patients worldwide.",
