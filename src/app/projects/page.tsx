...
const projects = [
  ...
  },
  {
    ...
    description: "A revolutionary AI-powered slide creation tool powered by a sophisticated 12-agent system that transforms any topic into stunning, animated slide decks with automated quality assurance, live widgets, and seamless export capabilities.",
    category: "AI Applications",
    icon: Brain,
    color: "from-purple-500 to-purple-600",
    year: "2025",
    status: "In Progress",
    technologies: ["Next.js 15", "React 18", "TypeScript", "Ollama", "Phi-4", "Gemma3-4B", "OpenAI", "Zod", "Playwright", "PptxGenJS", "Recharts", "IndexedDB"],
    problem: "Creating professional slide decks is time-consuming, inconsistent, and often lacks quality assurance. Teams need fast, high-quality presentations with automated fact-checking, accessibility compliance, and seamless export capabilities.",
    approach: "Built a revolutionary 12-agent AI system where specialized agents collaborate (Researcher, Structurer, Slidewriter, Fact Checker, Accessibility Linter, etc.). Features parallel processing (75% faster), smart model routing (60% improvement), 99% reliability, and 100% cost reduction with local Ollama.",
    impact: "Enables rapid creation of professional, quality-assured slide decks with automated fact-checking, WCAG compliance validation, readability analysis, and intelligent content generation. Supports both local Ollama (Phi-4, Gemma3-4B) and cloud OpenAI with 12 specialized AI agents working in harmony.",
    image: "/api/placeholder/400/250",
